...
<div id="cuerpo_action">
	...
	<form id="form_edit_client" method="POST" action="" enctype="multipart/form-data">
		...
		<p>Nombres del cliente</p>
			...
			?>
			<textarea name="notas" placeholder="Escriba las notas..." required><?=$nl?></textarea>
			<br/>
			
				<p>(*)  Respuesta final:</p>
			<?php
				$nlx = preg_replace('#<br\s*/?>#i', "", $row['respuesta']);
			?>
			<textarea name="respuesta" placeholder="Escriba la respuesta final..." required><?=$nlx?></textarea>
			<br/>
