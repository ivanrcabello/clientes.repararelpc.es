...
<?php
/* PAGINADOR */
$slug = '?action=ver_presupuestos';
$current = (   isset($_GET['page'])   )? $_GET['page'] : 1 ;
	$current = (   $current>0   )? $current : 1 ;
$post_per_page = 50;

		//Total de resultados
		$t_consulta = "SELECT * FROM presupuestos WHERE UID = ".$_SESSION['ID'];
...
<div id="cuerpo_action">
	...
	<?php
			...
			$consulta = "SELECT * FROM presupuestos WHERE UID = ".$_SESSION['ID']." ORDER BY PID DESC LIMIT ".$apartir_limit.",".$post_per_page;
